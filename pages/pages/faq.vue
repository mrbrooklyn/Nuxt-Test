                ...
                <div class="divide-y divide-white-light px-6 py-4.5 dark:divide-dark">
                    <div>
                        <div
                            ...
                            :class="{ 'bg-primary-light !text-primary dark:bg-[#1B2E4B]': active1 === 1 }"
                    ...
                    <div>
                        <div
                            class="flex cursor-pointer items-center justify-between gap-10 px-2.5 py-2 text-base font-semibold hover:bg-primary-light hover:text-primary dark:text-white dark:hover:bg-[#1B2E4B] dark:hover:text-primary"
                            :class="{ 'bg-primary-light !text-primary dark:bg-[#1B2E4B]': active1 === 2 }"
                    ...
                    <div>
                        <div
                            class="flex cursor-pointer items-center justify-between gap-10 px-2.5 py-2 text-base font-semibold hover:bg-primary-light hover:text-primary dark:text-white dark:hover:bg-[#1B2E4B] dark:hover:text-primary"
                            :class="{ 'bg-primary-light !text-primary dark:bg-[#1B2E4B]': active1 === 3 }"
                    ...
                    <div>
                        <div
                            class="flex cursor-pointer items-center justify-between gap-10 px-2.5 py-2 text-base font-semibold hover:bg-primary-light hover:text-primary dark:text-white dark:hover:bg-[#1B2E4B] dark:hover:text-primary"
                            :class="{ 'bg-primary-light !text-primary dark:bg-[#1B2E4B]': active1 === 5 }"
            ...
            <div class="rounded-md bg-white dark:bg-black">
                ...
                <div class="divide-y divide-white-light px-6 py-4.5 dark:divide-dark">
                    <div>
                        <div
                            class="flex cursor-pointer items-center justify-between gap-10 px-2.5 py-2 text-base font-semibold hover:bg-primary-light hover:text-primary dark:text-white dark:hover:bg-[#1B2E4B] dark:hover:text-primary"
                            :class="{ 'bg-primary-light !text-primary dark:bg-[#1B2E4B]': active2 === 1 }"
                    ...
                    <div>
                        <div
                            class="flex cursor-pointer items-center justify-between gap-10 px-2.5 py-2 text-base font-semibold hover:bg-primary-light hover:text-primary dark:text-white dark:hover:bg-[#1B2E4B] dark:hover:text-primary"
                            :class="{ 'bg-primary-light !text-primary dark:bg-[#1B2E4B]': active2 === 2 }"
                    ...
                    <div>
                        <div
                            class="flex cursor-pointer items-center justify-between gap-10 px-2.5 py-2 text-base font-semibold hover:bg-primary-light hover:text-primary dark:text-white dark:hover:bg-[#1B2E4B] dark:hover:text-primary"
                            :class="{ 'bg-primary-light !text-primary dark:bg-[#1B2E4B]': active2 === 3 }"
                    ...
                    <div>
                        <div
                            class="flex cursor-pointer items-center justify-between gap-10 px-2.5 py-2 text-base font-semibold hover:bg-primary-light hover:text-primary dark:text-white dark:hover:bg-[#1B2E4B] dark:hover:text-primary"
                            :class="{ 'bg-primary-light !text-primary dark:bg-[#1B2E4B]': active2 === 5 }"
