    ...
    <div>
        ...
        <div class="panel pb-0 mt-6">
            <div class="mb-5 flex flex-col gap-5 md:flex-row md:items-center">
                <h5 class="text-lg font-semibold dark:text-white-light">Alt Pagination</h5>
        ...
        <div class="panel mt-6 pb-0">
            <div class="mb-5 flex flex-col gap-5 md:flex-row md:items-center">
                <h5 class="text-lg font-semibold dark:text-white-light">Pagination Without Number</h5>
                <div class="ltr:ml-auto rtl:mr-auto">
        ...
        <div class="panel mt-6 pb-0">
            <div class="mb-5 flex flex-col gap-5 md:flex-row md:items-center">
                <h5 class="text-lg font-semibold dark:text-white-light">Next Previous</h5>
                <div class="ltr:ml-auto rtl:mr-auto">
...
<script setup lang="ts">
    ...
    useHead({ title: 'Alternative Pagination' });
    const search1 = ref('');
    const search2 = ref('');
    const search3 = ref('');
    const search4 = ref('');
