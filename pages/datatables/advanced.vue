<template>
    <div>
        ...
        <div class="panel pb-0 mt-6">
            <h5 class="mb-5 text-lg font-semibold dark:text-white-light">Advanced</h5>
            <div class="datatable">
                <vue3-datatable
                    :rows="rows"
                    :columns="cols"
                ...
                >
                    ...
                    <template #firstName="data">
                        <div class="flex items-center gap-2">
                            <img :src="`/assets/images/profile-${getRandomNumber(1, 34)}.jpeg`" class="h-9 w-9 max-w-none rounded-full" alt="user-profile" />
